...
class TestUnaryOperations(unittest.TestCase):
    def test_logical_true(self):
        self.assertTrue(truth_table.logical_true(True))
        self.assertTrue(truth_table.logical_true(False))

    def test_logical_false(self):
        self.assertFalse(truth_table.logical_false(True))
        self.assertFalse(truth_table.logical_false(False))
...
class TestBinaryOperations(unittest.TestCase):
    ...
    def test_material_nonimplication(self):
        self.assertFalse(truth_table.material_nonimplication(True, True))
        self.assertTrue(truth_table.material_nonimplication(True, False))
        self.assertFalse(truth_table.material_nonimplication(False, True))
        self.assertFalse(truth_table.material_nonimplication(False, False))
