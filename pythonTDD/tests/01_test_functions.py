...
class TestFunctions(unittest.TestCase):
    ...
    def test_passthrough(self):
        ...
        self.assertEqual(
            functions.passthrough(list(("my_first_name", "my_other_name"))),
            ["my_first_name", "my_other_name"],
        )
        self.assertEqual(
            functions.passthrough(dict(my_first_name="my_first_name")),
    ...
    def test_functions_with_unknown_number_of_keyword_arguments(self):
        self.assertEqual(functions.keyword_counter(a=1, b=2, c=3, d=4), 4)
        self.assertEqual(functions.keyword_counter(a=1, b=2), 2)

    def test_functions_with_unknown_number_of_positional_arguments_and_keyword_arguments(
        self,
    ):
        self.assertEqual(functions.argument_counter(1, 2, 3, 4, a=5, b=6, c=7, d=8), 8)
        self.assertEqual(functions.argument_counter(1, 2, c=7, d=8), 4)
